            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
                ...
                <div class="bg-white rounded-xl shadow-sm p-4 sm:p-6 border border-gray-100">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h2 class="text-base sm:text-lg font-semibold text-gray-900">{{ $internsCount ?? 0 }}</h2>
                            <p class="text-xs sm:text-sm text-gray-500">Total Interns</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm p-4 sm:p-6 border border-gray-100">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h2 class="text-base sm:text-lg font-semibold text-gray-900">{{ $activeTasks ?? 0 }}</h2>
                            <p class="text-xs sm:text-sm text-gray-500">Active Tasks</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm p-4 sm:p-6 border border-gray-100">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h2 class="text-base sm:text-lg font-semibold text-gray-900">{{ $commentsCount ?? 0 }}</h2>
                            <p class="text-xs sm:text-sm text-gray-500">Total Comments</p>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="flex items-start sm:items-center justify-between">
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="mt-2 flex items-center">
                                                ...
                                                <span
                                                    class="ml-2 text-xs sm:text-sm text-gray-500">{{ $task->interns->count() }}
                        ...
                        <div class="p-4 sm:p-6">
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                                    <div
                                        class="w-12 h-12 sm:w-16 sm:h-16 bg-indigo-100 rounded-full flex items-center justify-center">

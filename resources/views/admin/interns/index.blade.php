    ...
    @push('scripts')
        <script>
            ...
            function confirmDelete(internId, internName) {
                Swal.fire({
                    title: 'Are you sure?',
                    text: `Do you want to delete intern "${internName}"? This action cannot be undone.`,
                    icon: 'warning',
            ...
            function deleteIntern(internId) {
                $.ajax({
                    ...
                    beforeSend: function() {
                        ...
                        $(`#intern-row-${internId} button`).prop('disabled', true);
                    },
                    ...
                    error: function(xhr) {
                        ...
                        $(`#intern-row-${internId} button`).prop('disabled', false);

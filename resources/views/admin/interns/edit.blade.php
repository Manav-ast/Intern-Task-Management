        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="md:flex md:items-center md:justify-between mb-8">
                <div class="flex-1 min-w-0">
                    <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">Edit Intern</h2>
                    <p class="mt-1 text-sm text-gray-500">Update intern information and access details.</p>
                </div>
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                <div class="p-8">
                    <form method="POST" action="{{ route('admin.interns.update', $intern) }}" class="space-y-8"
                        id="editInternForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="space-y-8">
                            ...
                            <div>
                                <label for="password" class="block text-sm font-medium text-gray-700 mb-2">
                                    New Password
                                    <span class="text-sm text-gray-500 ml-1">(leave blank to keep current password)</span>
                                </label>
                                <div class="relative rounded-lg shadow-sm">

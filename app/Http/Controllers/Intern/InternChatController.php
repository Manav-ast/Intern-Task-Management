...
class InternChatController extends Controller
{
    public function index()
    {
        try {
            ...
            return view('intern.chat.index', compact('messages'));
        } catch (\Exception $e) {
    ...
    public function show($id)
    {
        try {
            ...
            return view('intern.chat.show', compact('messages', 'otherUser'));
        } catch (\Exception $e) {
            Log::error('Error loading chat conversation: ' . $e->getMessage());
            return redirect()->route('intern.chat.index')->with('error', 'Error loading chat conversation. Please try again.');
        }
    }
    ...
    public function getUsers()
    {
        try {
            ...
            return view('intern.chat.users', compact('users'));
        } catch (\Exception $e) {
